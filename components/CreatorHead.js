...
function HeadTag({ title, keywords, img }) {
	...
	const metaDesc = "Explore " + title + "'s properties on Real Dukaan. India's shop listing platform which lets you explore shops easily and efficiently. Explore commercial shops now."
	return (
		<Head>
