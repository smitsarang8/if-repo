...
const ProductItem = ({ authors }) => {
	...
	const twitterLink = () => {
		if (authors.fields.twitter != "") {
			return <a href={authors.fields.twitter} class="text-white hover:text-blue-300">
	...
	const personalWeb = () => {
		if (authors.fields.personalWeb) {
			return <a href={authors.fields.personalWeb} class="text-white hover:text-blue-300"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
			...
			>
				<div class="max-w-sm py-5">
					...
					<div class="p-4">
						...
						<div class="pt-8 flex w-44 mx-auto text-gray-500 items-center justify-between">
							{authors.fields.twitter ? twitterLink() : null}
							{authors.fields.linkedin ? linkedinLink() : <div></div>}
							{authors.fields.personalWeb ? personalWeb() : null}
