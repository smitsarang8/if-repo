    ...
    <div class="row-span-2">
      ...
      <section class="text-gray-600 ">
        <div class="container px-5 mx-auto">
          ...
          <a href="/shops/"  class="transition duration-300 p-4 md:w-1/5">
            ...
            <a href="/offices"  class="transition duration-300 p-4 md:w-1/5">
            <div class="h-full px-4 rounded-lg overflow-hidden">
            ...
            <a href="/land-plots"  class="transition duration-300 p-4 md:w-1/5">
            <div class="h-full px-4 rounded-lg overflow-hidden">
            ...
            <a href="/storages"  class="transition duration-300 p-4 md:w-1/5">
            <div class="h-full px-4 rounded-lg overflow-hidden">
            ...
            <a href="/hospitalities" class="transition duration-300 p-4 md:w-1/5">
            <div class="h-full px-4 rounded-lg overflow-hidden">
