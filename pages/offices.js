...
const Offices = () => {
	...
	const address = "https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{propertyType}='office')";
	...
	return (<>
		<Head>
			<title>Offices - Real Dukaan</title>
			<meta name="description" content="Offices at Real dukaan" />
			...
			<meta property="og:description" content="Explore offices at Real Dukaan. India's shop listing platform which enables users to explore shops easily. Explore commercial shops now." />
