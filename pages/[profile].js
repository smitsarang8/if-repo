...
const Owner = ({ authors, products, projects }) => {
	...
	const twitterLink = () => {
		if (authors.records[0].fields.twitter != "") {
			return <a href={authors.records[0].fields.twitter} class="text-white hover:text-blue-300">
	...
	const personalWeb = () => {
		if (authors.records[0].fields.personalWeb) {
			return <a href={authors.records[0].fields.personalWeb} class="text-white hover:text-blue-300"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
