...
const Offices = () => {
	...
	const address = "https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{propertyType}='land-plot')";
	...
	return (<>
		<Head>
			<title>Land plots - Real Dukaan</title>
			<meta name="description" content="Land plots at Real dukaan" />
			<link rel="icon" href="https://dl.airtable.com/.attachmentThumbnails/3fbe59fbd3d405d40173f878ff5187ca/9f0069ed" />
			<meta property="og:title" content="Offices at Real dukaan" />
			<meta property="og:description" content="Explore land plots at Real Dukaan. India's shop listing platform which enables users to explore shops easily. Explore commercial shops now." />
