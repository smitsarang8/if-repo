...
const SearchQuery = ({ }) => {
	...
	useEffect(() => {
		...
		if (router.query.searchQuery.length === 3) {
			if (router.query.searchQuery[0] === 'buy' && router.query.searchQuery[1] != "" && router.query.searchQuery[2] != "") {
				address = `https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{purpose}='sell',{city}='${router.query.searchQuery[1]}',{area}='${router.query.searchQuery[2]}')`;
			} else if (router.query.searchQuery[0] === 'rent' && router.query.searchQuery[1] != "" && router.query.searchQuery[2] != "") {
				address
					= `https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{purpose}='rent',{city}='${router.query.searchQuery[1]}',{area}='${router.query.searchQuery[2]}')`;
			}
		}

		if (router.query.searchQuery.length === 2) {

			if (router.query.searchQuery[0] === 'buy' && router.query.searchQuery[1] != "") {
				address = `https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{purpose}='sell',{city}='${router.query.searchQuery[1]}')`;
			} else if (router.query.searchQuery[0] === 'rent' && router.query.searchQuery[1] != "") {
				address = `https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{purpose}='rent',{city}='${router.query.searchQuery[1]}')`;
			}
		}

		if (router.query.searchQuery.length === 1) {
			if (router.query.searchQuery[0] === 'buy') {
				address = `https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{purpose}='sell')`;
			} else if (router.query.searchQuery[0] === 'rent') {
				address = `https://api.airtable.com/v0/appgsdBi4Ssk6GHRs/listing_requests?filterByFormula=AND({status}='approved',{purpose}='rent')`;
			}
		}
