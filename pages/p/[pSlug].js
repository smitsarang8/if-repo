...
const Product = ({ product, author }) => {
	...
	const purpose = () => {
		if (product.records[0].fields.purpose == "sell") {
			return <span class="inline-block rounded-md sm:text-black  py-1 text-xs">SELL</span>
				;
		} else if (product.records[0].fields.purpose == "rent") {
			return <span class="inline-block rounded-md sm:text-black  py-1 text-xs">RENT</span>
				;
		}
	}
								...
								<div class="container px-1 mx-auto flex flex-wrap">
									<main class="py-6 px-4 sm:p-6 md:py-10 md:px-8">
										...
										<div class="px-4 max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
											...
											<dl class="mt-4 text-xs font-medium  items-center row-start-2 sm:mt-1 sm:row-start-3 md:mt-2.5 lg:row-start-2">
											</dl>
											...
											<p class="mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-gray-400">
												<div class="px-4 sm:px-6 mt-2 lg:mt-0 lg:row-span-4 pr-3 py-2">
												...
												<div class="px-4 sm:px-6 mt-2 lg:mt-0 lg:row-span-4">
													<button
														...
														class="px-4 w-full mt-4 bg-indigo-500 hover:bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white "
													>
														View Floor Plan
													</button>
													{showModal ? (
								...
								<div>
									...
									<div class="px-4">
										<div class="px-4">
											...
											<div class="px-4 mt-4"><p class="text-2xl font-bold text-gray-700 hover:underline">About property</p>
												<p class="mt-2 text-gray-600">
													<div class="">
